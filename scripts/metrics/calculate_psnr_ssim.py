...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', type=str, default='results/crop_patch4/gt', help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default='results/crop_patch4/bsrn', help='Path to restored images')
